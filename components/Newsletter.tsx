...
const Newsletter = () => {
  return (
    <div className="px-24 py-40 flex items-center justify-center text-white text-shadow-md">
      <div className="flex flex-col gap-4 md:gap-8 lg:gap-14 p-14 rounded-4xl text-center items-center
        ...
        <p className="text-sm md:text-lg lg:text-2xl max-w-180">
          Subscribe to get the latest news and updates from your favorite topics directly in your inbox{" "}
        ...
        <form className="flex items-center justify-center gap-8 border-b-2 md:border-b-4 p-4
          ...
          hover:md:border-red-500 transition-all duration-600 w-60 hover:md:w-100
